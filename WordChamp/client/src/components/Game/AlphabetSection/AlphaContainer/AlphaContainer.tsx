...
const AlphaContainer: React.FC<Props> = ({ alphabet }) => {
    return (
        <motion.div
            className='flex items-center justify-center w-14 h-14 mx-2 mb-4 rounded-lg bg-gradient-to-r from-orange-500 to-yellow-400 text-white text-xl md:text-3xl font-frick shadow-lg hover:shadow-xl transition-transform transform hover:scale-110 relative'
            variants={{
